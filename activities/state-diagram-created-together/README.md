...
The goal of this activity is to practice creating a state diagram on a particular assignment of a specified use case. The diagram is being created step-by-step on a whiteboard by all students.
...
* Preparation
  * Let students read the task and make sure they understand it (task.pdf).
* Creation
  * Students go one by one to the whiteboard and make a piece of the diagram.
...
* Be aware of the space on the whiteboard. Adjust the created pieces of the diagram based on it. You can check the attached solution to help you with it (solution.pdf).
* If the student makes a mistake, you don't need to correct it immediately, but let the other students find it.
...
* You do not need to end with the exact diagram as in (solution.pdf). However, it has to make sense.
